...
class ConvertForms extends \TYPO3\CMS\Scheduler\Task\AbstractTask {
    ...
    function convertForms()
    {
        ...
        $i=0;
        $res = $GLOBALS['TYPO3_DB']->exec_SELECTquery("t.uid, t.pid, t.bodytext, t.subheader, t.sorting, t.pages", "tt_content t JOIN pages p ON p.uid = t.pid", "t.CType = 'mailform' AND t.deleted = 0 AND t.hidden=0 AND p.deleted = 0 AND p.hidden=0 AND p.uid IN(1717,3144,3268,6744)");
