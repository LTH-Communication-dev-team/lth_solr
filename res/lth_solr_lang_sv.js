var lth_solr_messages = {
    abstract: "Abstract",
    accessToDocument: "Access till dokument",
    additionalLink: "Andra länkar",
    allPublications: "Alla publikationer",
    authorLastName: "Efternamn",
    authors: "Författare",
    bibliographicalNote: "Bibliografisk not",
    citeThis: "Citera detta",
    city: "Stad",
    close: "Stäng",
    country: "Land",
    ...
    fromLucris: "Hämtat ur Lunds universitets publikationsdatabas",
    fulltext: "Fulltext",
    hits: "träffar",
    ...
    room: "Rum",
    showAllPublications: "Visa alla publikationer",
    showLatestPublications: "Visa senaste publikationer",
    show_all: "Visa alla",
    show_more: "Visa fler",
